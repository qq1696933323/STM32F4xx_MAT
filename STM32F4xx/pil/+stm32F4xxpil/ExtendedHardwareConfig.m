...
%   This file is required for PIL implementations whose target
%   processor uses 16-bit char.
%
...
% Copyright 2011 The MathWorks, Inc.
    ...
    methods
        ...
        % or not.
        function byteAddressable = isByteAddressable(this) %#ok
        ...
        function wordOrder = getDatatypeWordOrder(this, ~, ~) %#ok
        ...
        function size = getDatatypeSize(this, simulinkType) %#ok
