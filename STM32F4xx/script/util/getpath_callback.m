...
%Also set default parameters for compil, link and asm
	...
	if (strcmp(slConfigUIGetVal(hDlg, hSrc, paramName),'IAR')) 
		...
		slConfigUISetVal(hDlg, hSrc, 'CompilerSettings', '--cpu Cortex-M4 --debug -D ARM_MATH_CM4 -D $(STM32_SERIES) -D USE_STDPERIPH_DRIVER --endian=little');
    ...
    if (strcmp(slConfigUIGetVal(hDlg, hSrc, paramName),'KEIL'))
        ...
        %Set dongle possibilities
		slConfigUISetVal(hDlg, hSrc, 'Dongle', 'STLinkV2');
		slConfigUISetVal(hDlg, hSrc, 'CompilerSettings', '--cpu Cortex-M4.fp -c -g -O0 -DARM_MATH_CM4 -D$(STM32_SERIES) -DUSE_STDPERIPH_DRIVER --apcs=interwork --split_sections --c99');
	...
	if (strcmp(slConfigUIGetVal(hDlg, hSrc, paramName),'ATOLLIC')) 
        ...
        %Set dongle possibilities								
		slConfigUISetVal(hDlg, hSrc, 'Dongle', 'STLinkV2');
		slConfigUISetVal(hDlg, hSrc, 'CompilerSettings', '-c -g -mcpu=cortex-m4 -O0 -Wall -ffunction-sections -fdata-sections -mthumb -D $(STM32_SERIES) -D USE_STDPERIPH_DRIVER  -D ARM_MATH_CM4');
